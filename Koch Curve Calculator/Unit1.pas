...
uses
  ...
  ExtCtrls, StdCtrls, ExtDlgs, Grids, Buttons, Menus, XPMan;
...
procedure TForm1.lsystempaint(canvas:tcanvas);
...
var   p,q:integer;
  ...
  begin
    if fehler then begin
      ...
      canvas.textout(round(x),round(y),'Iteration depth too high');
    end;
    button1.caption:='Depiction';
    labbruch:=true;
...
procedure TForm1.B1Darst(Sender: TObject);
var bitmap:tbitmap;
begin
...
procedure TForm1.B3Spei(Sender: TObject);
var k:string;
    i:integer;
begin
...
procedure TForm1.B2Loesch(Sender: TObject);
var k:string;
    ort,sel:integer;
begin
  sel:=LBox.itemindex;
