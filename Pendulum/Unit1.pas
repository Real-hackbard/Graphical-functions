...
uses
  ...
  aiOGL, OpenGL, ExtCtrls, StdCtrls;
...
var
  ...
  StartTime: TDateTime;
  CurGr: single;
  CyclicFrequency: single;

  AttenuationConstant: single;
  StartingAngle: single;
...
begin
  ...
  glPushMatrix();
  glTranslatef(0, 8, 0);
  gluCylinder(Form1.q, 0.1, 0.1, 1, 20, 20);
  glPopMatrix();

  glPushMatrix();
  glTranslatef(0, 8, 0.5);
  gluSphere(Form1.q, 0.2, 20, 20);
  glPopMatrix();
  ...
  gluCylinder(Form1.q, 0.1, 0.1, 12, 20, 20);
  glPopMatrix();
...
begin
  ...
  MyScene.AddObject(CreatePlane(Vector(-10, 10, 0),
                                Vector(10, 10, 0),
                                Vector(10, -10, 0),
                                Vector(-10, -10, 0)));
