...
begin
    ...
    // Displacement of the inner wheel
    xm:=w12*cos(wi);
    ym:=-w12*sin(wi);

    // Auxiliary corners for Reuleaux triangle
    exzent:=4*wert1+w12;
    ...
    // Points of the Reuleaux triangle
    radius:=exzent;
    ...
    // Transform Reuleaux triangle to window and rotate points
...
// Pre-calculate engine compartment
procedure huelle;
