...
uses
  ...
  ExtCtrls, ComCtrls, ToolWin, BSim, StdCtrls, Menus, ImgList;
...
procedure TForm1.UpdateSelStats;
begin
...
procedure TForm1.GravpbPaint(Sender: TObject);
var
   xc, yc   : integer;
   rad      : integer;
   xd, yd   : integer;
...
procedure TForm1.GravpbMouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
   GravDown := True;
...
procedure TForm1.GravpbMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
   GravDown := False;
end;

procedure TForm1.GravpbMouseMove(Sender: TObject; Shift: TShiftState; X,
  Y: Integer);
var
   xc, yc   : integer;
   xd, yd   : integer;
...
begin
   ...
   begin
      ...
      bs.GravY := yd / d;
      GravPB.Refresh;
   Panel6.Caption := 'Angle : ' + IntToStr(xd) + ' ' + IntToStr(yd);
   end;

end;

procedure TForm1.SelectPoint(x,y: integer);
var
   p : TBPoint;
begin
...
procedure TForm1.ShapeMenuClick(Sender: TObject);
var
   Num   : integer;
   i, j  : integer;
   ang   : double;
